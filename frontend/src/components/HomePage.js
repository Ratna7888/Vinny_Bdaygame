...
function HomePage() {
  ...
  useEffect(() => {
    console.log(`Frame: ${currentFrame}, Walking: ${isWalking}`);
  }, [currentFrame, isWalking]);
  ...
  const characterImage = direction === 'right'
    ...
    <div className="homepage-container">
      ...
      <div className="world-map" style={{ 
        ...
        <div className="world-object shop" style={{ left: `${locations.level1.x}px` }}>
          <img src="/images/city/shop-dress.png" alt="Dress Shop" />
        </div>
        <div className="world-object shop" style={{ left: `${locations.level2.x}px` }}>
          <img src="/images/city/shop-bakery.png" alt="Bakery" />
        </div>
        <div className="world-object shop" style={{ left: `${locations.level3.x}px` }}>
          <img src="/images/city/shop-battlefield.png" alt="Battlefield" />
        </div>
        <div className="world-object shop" style={{ left: `${locations.finale.x}px` }}>
          <img src="/images/city/shop-spy-hq.png" alt="Spy HQ" />
        </div>

        {/* Character container handles position transition */}
        <div 
